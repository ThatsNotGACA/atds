...
def main():
    ...
    for n in sizes:
        ...
        print("List-based Stack: " + str(list_push) + " seconds")
        print("UnorderedListStack: " + str(linked_push) + " seconds")
        list_pop = test_pop(Stack, n)
        linked_pop = test_pop(UnorderedListStack, n)
        print("Pop Operations:")
        print("List-based Stack: " + str(list_pop) + " seconds")
        print("UnorderedListStack: " + str(linked_pop) + " seconds")
        print()
